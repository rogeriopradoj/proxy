...
echo.==================================================================
echo.
echo. Voc� pode passar o par�metro -y para n�o ser questionado e
echo. deixar os valores padr�es ser�o utilizados.
echo. 
echo.     ^> proxy_start.bat -y
echo. 
echo. Observa��o.: A senha(Password) sempre � solicitada.
echo.
echo.==================================================================
echo.
pause
